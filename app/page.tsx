    ...
    <div className="min-h-screen font-sans">
      ...
      <main className="relative z-10 bg-brand-background flex flex-col items-center justify-center text-center w-full mx-auto px-6 md:px-20 pt-20 pb-20">
        <div className="max-w-4xl">
          <h3 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight pb-3">Know when your site <span className="text-brand-primary">goes down</span><br /> before your users do</h3>
          <p className="text-lg font-medium text-brand-text-muted text-center">Uptime Watcher checks your websites every 5 minutes and alerts you instantly when something breaks. Simple setup, powerful monitoring.</p>
        </div>
